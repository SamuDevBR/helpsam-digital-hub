...
export const TopBar = () => {
  // Duplicate the list so the -50% translate creates a seamless infinite loop.
  ...
  return (
    ...
    >
      <div className="h-8 flex items-center overflow-hidden">
        <div className="flex gap-10 md:gap-16 whitespace-nowrap animate-[marquee_18s_linear_infinite] md:animate-[marquee_28s_linear_infinite] pl-10 md:pl-16">
